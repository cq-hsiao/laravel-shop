                    ...
                    <div class="row">
                        ...
                        <!-- 众筹商品模块结束 -->
                            ...
                            <div class="cart_amount"><label>数量</label>
                                <input type="text" class="form-control form-control-sm" value="1"  @if($product->type === \App\Models\Product::TYPE_SECKILL) disabled="disabled" @endif>
                                <span>件</span><span class="stock"></span></div>
                            <div class="buttons">
                                @if($favored)
...
{{--                                        @endforeach--}}
                            ...
                            <div role="tabpanel" class="tab-pane" id="product-reviews-tab">
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    @foreach($reviews as $review)
                                        <tr>
                                            ...
                                            <td>{{ $product->title.'['.$review->productSku->title.']' }}</td>
                                ...
                                <div class="float-right">{{ $reviews->render() }}</div>
                                <!-- 评论列表结束 -->
                            </div>
                        </div>
                    </div>
